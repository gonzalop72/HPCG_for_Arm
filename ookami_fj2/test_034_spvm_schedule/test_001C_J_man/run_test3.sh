...
if [ $size -eq 144 ]; then
	...
	list=(0 4 80 160 240 320 400 480 560 640 680 720 760 800 880 960 1040 1600 3200 6400)
elif [ $size -eq 176 ]; then
	list=(0 4 88 176 264 352 440 528 616 645 704 748 792 880 924 968 1012 1188 1760	1936 3872 7744)
else #192
