...
OMP_SCHEDULE="static,640" ./create_test.sh test_004_unroll6_sch1 "-DUNROLLING_6_A" 176
OMP_SCHEDULE="static,640" ./create_test.sh test_004_unroll6_sch2 "-DUNROLLING_6_B" 176
OMP_SCHEDULE="static,640" ./create_test.sh test_004_unroll6_man "-DUNROLLING_6_C" 176
